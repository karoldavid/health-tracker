var app=app||{};app.Food=Backbone.Model.extend({url:function(){return"/api/myfood/"+encodeURIComponent(this.id)},ocalStorage:!0,idAttribute:"_id",defaults:{_id:"",name:"",fat:0,carbs:0,protein:0,calories:0},parse:function(e){if("undefined"!=typeof e.fields){var a={};return a._id=e._id,a.name=e.fields.item_name,a.calories=e.fields.nf_calories,a.fat=e.fields.nf_total_fat,a.carbs=e.fields.nf_total_carbohydrate,a.protein=e.fields.nf_protein,a}return e}});
